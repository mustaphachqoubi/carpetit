    ...
    <>
      {newCheckoutToken.length < 1 ? (
        <div className="w-full p-20 h-96 flex justify-center items-center ">
          ...
          <div className="grid md:grid-cols-2 gap-5 justify-center md:justify-between">
            {!newCheckoutToken ? (
              ...
              newCheckoutToken?.line_items.map((carpet) => (
                <div className="flex gap-6 items-end" key={carpet.id}>
          ...
          <div className="flex justify-center md:justify-between items-center py-5 flex-col md:flex-row">
            <div className="font-semibold text-lg  py-5 flex gap-1 justify-center align-center text-center">
          ...
          <div className="w-full px-[10rem] md:px-0">
          <hr />
          </div>
          <h1 className="font-semibold text-lg py-5">Payment method</h1>
          <div className="flex justify-center items-center px-20 sm:px-0">
          <div className="w-[50%] md:w-full flex flex-col justify-center items-stretch ">

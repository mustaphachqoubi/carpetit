...
const Carpet = ({ products, onAddToCart, searchCarpet }) => {
  ...
  const FitchCarpet = () => {
    setFiltered(
      products.filter((carpet) =>
        carpet.name.toLowerCase().includes(searchCarpet)
      )
    );
  };
        ...
        ? filtered.map((carpet) => (
            ...
            >
              <div className="relative">
                <h3 className="bg-red-200 px-3 py-1 rounded-md text-red-500 absolute top-4 left-4 font-semibold shadow-lg text-lg">
                  -70%
                </h3>
                <img
